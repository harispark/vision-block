...
class CImageNdg {
	...
	///////////////////////////////////////
		...
		_declspec(dllexport) std::vector<int> histogrammeInt(bool enregistrementCSV = false, int pas = 1); // 1 : pas de quantification
		...
		_declspec(dllexport) CImageNdg Contraste(double contrastValue, byte brightness);
};
